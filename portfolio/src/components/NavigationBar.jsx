...
export default function NavigationBar({ selectedFolder, activeView, onBack, onSearch }) {
  ...
  // Show back button ONLY when in a folder inside Desktop
  const showBackButton = activeView === "desktop" && selectedFolder !== null
